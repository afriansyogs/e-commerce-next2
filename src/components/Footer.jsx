...
const Footer = () => {
    return (
        <footer className="bg-black w-full h-auto p-5 text-white bottom-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        ...
                        <li className="py-2">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full py-2 ps-4 pe-9 border border-white bg-transparent text-white placeholder-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
                                />
                ...
                <div className="w-[217px] ms-5 lg:ms-12">
                    ...
                    <ul>
                        <li className="py-2">
                            <p className="text-[16px]">SetiaBudi 115, Jakarta Selatan, DKI Jakarta, Indonesia.</p>
                        </li>
                        <li className="py-2">
                            <p className="text-[16px]">exclusive@gmail.com</p>
                        </li>
                        <li className="py-2">
                            <p className="text-[16px]">+62-812-456-3374</p>
                        </li>
                    </ul>
                </div>
                <div className="w-44 ms-5 lg:ms-16">
                    ...
                    <ul>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">My Account</a>
                        </li>
                        <li className="py-2">
                            <Link href="/SignUp" className="text-[16px] hover:underline cursor-pointer">Login / Register</Link>
                        </li>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">Cart</a>
                        </li>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">Wishlist</a>
                        </li>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">Shop</a>
                        </li>
                    </ul>
                </div>
                <div className="ms-5">
                    ...
                    <ul>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">Privacy Policy</a>
                        </li>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">Terms Of Use</a>
                        </li>
                        <li className="py-2">
                            <a href="#" className="text-[16px] hover:underline">FAQ</a>
                        </li>
                        <li className="py-2">
