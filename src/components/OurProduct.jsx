...
const OurProduct = () => {
    return (
        <div className="mt-16 ms-[10px] md:ms-8 lg:ms-[70px] w-[95%] md:w-[91%] lg:w-[90%]">
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-10 mt-11 justify-center">
                {productData.slice(0, 8).map((item, index) => (
                    <div key={index} className="group relative card bg-base-100 w-72 md:w-56 lg:w-72 shadow-xl overflow-hidden" data-aos="fade-up">
                        <figure className="w-full h-48 md:h-32 lg:h-48 flex justify-center items-center bg-gray-200 relative">
