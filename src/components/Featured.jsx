...
const Featured = () => {
    ...
    return (
        <div className="mt-16 ms-[10px] md:ms-8 lg:ms-[70px] w-[95%] md:w-[91%] lg:w-[90%] pb-10">
            <Point text="Featured" />
            ...
            <div className="mt-6 lg:mt-12 flex flex-col md:flex-row gap-y-8 md:gap-x-4 lg:gap-x-8">
                <div className="relative md:w-1/2 h-[400px] md:h-[600px] bg-black flex items-end justify-center" data-aos="fade-right">
                    ...
                    />
                    <div className="absolute bottom-3 left-4 md:left-3 lg:left-10 p-4 text-white">
                ...
                <div className="md:w-1/2 bg-transparent flex flex-col gap-y-8 md:gap-y-4 lg:gap-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-y-8 md:gap-x-4 lg:gap-x-8">
                        <div className="relative w-full h-[284px] md:h-[300px] lg:h-[284px] bg-black flex items-center justify-center" data-aos="fade-up">
                            <Image 
