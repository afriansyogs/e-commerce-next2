...
const BestProduct = () => {
    ...
    return (
        <div className="mt-14 ms-[10px] md:ms-[70px] w-[95%] md:w-[90%]">
            <Point text="This Month" />
            <div className="mt-2 flex justify-between items-end">
                <div className="text-2xl md:text-4xl lg:text-[36px] font-bold">Best Selling Products</div>
                <button className='hidden sm:block w-40 h-14 rounded-md bg-red-500 text-white border-2 hover:bg-white hover:text-red-500 hover:border-red-500 active:scale-110 transition duration-200'>View All</button>
            </div>
            ...
            <div className="mt-32 bg-black w-full h-auto lg:h-[520px] grid grid-cols-1 lg:grid-cols-2" data-aos="zoom-in" data-aos-duration="600">
                <div className="ps-5 sm:ps-10 lg:ps-14 pt-8 sm:pt-12 lg:pt-16">
                    ...
                    <button className="hidden sm:block bg-green-500 w-[180px] sm:w-[200px] h-12 sm:h-14 mt-8 sm:mt-10 rounded-sm border-[3px] border-green-500 active:scale-110 transition duration-200 text-white text-sm sm:text-base font-medium text-center hover:text-green-400 hover:bg-white hover:border-green-500">
                        Buy Now!
                    </button>
                </div>
                <div className="flex items-center justify-center mt-8 lg:mt-0">
                    <Image 
                        ...
                        width={320} 
                        height={240} 
                        className="lg:w-[560px] lg:h-[410px] filter drop-shadow-white"
                    />
                </div>
